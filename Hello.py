...
def ImproveData(PathToFile,Pb,Pb2):
    ...
    try:
        if not os.path.exists('OriginalData'):
            ...
            os.makedirs('DenoiseData')
            os.makedirs('ImageBordersData')
    ...
    Dic_of_Pixel={}
    Original_Image = Image.open('./DenoiseData/DenoisedFrame5.png')
    global width, height
    width, height = Original_Image.size
    kernel = np.array([[0,-1,0],[-1,5,-1],[0,-1,0]])
    for k in range(2,CountOfImages-1):
        name = './DenoiseData/DenoisedFrame' + str(k) + '.png'
        nameBorder = './ImageBordersData/BorderFrame' + str(k) + '.png'
        Grad(name,nameBorder,Dic_of_Pixel)
        nameFinal = './FinalData/FinalFrame' + str(k) + '.png'
        # Sharpen of image
    ...
    image_folder = './FinalData/'
    video_name = 'DenoisedVideoFinalData.mov'
    video_name2 = 'DenoisedVideoFinalData.mp4'
    image_folderDen = './DenoiseData/'
    video_nameDen = 'DenoisedVideoDenoisedData.mov'
    video_nameDen2 = 'DenoisedVideoDenoisedData.mp4'
    image_folderBor = './ImageBordersData/'
    video_nameBor = 'BordersVideo.mov' 
    video_nameBor2 = 'BordersVideo.mp4'
